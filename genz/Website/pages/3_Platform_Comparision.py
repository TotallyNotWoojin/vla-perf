...
system_datasheet = {
    'A100_40GB':'https://www.nvidia.com/content/dam/en-zz/Solutions/Data-Center/a100/pdf/nvidia-a100-datasheet-nvidia-us-2188504-web.pdf',
    'A100_80GB':'https://www.nvidia.com/content/dam/en-zz/Solutions/Data-Center/a100/pdf/nvidia-a100-datasheet-nvidia-us-2188504-web.pdf',
    'A100_80GB':'https://www.nvidia.com/content/dam/en-zz/Solutions/Data-Center/a100/pdf/nvidia-a100-datasheet-nvidia-us-2188504-web.pdf',
    'H100':'https://resources.nvidia.com/en-us-tensor-core/nvidia-tensor-core-gpu-datasheet', 
    'GH200':'https://resources.nvidia.com/en-us-grace-cpu/grace-hopper-superchip', 
...
def main():
    ...
    if 'system_list' not in st.session_state:
        st.session_state.system_list = [
            {'name':'A100_80GB',
            'Flops': system_configs['A100_80GB'].get('Flops', ''),
            'Memory_BW': system_configs['A100_80GB'].get('Memory_BW', ''),
            'Memory_size': system_configs['A100_80GB'].get('Memory_size', ''),
            'ICN': system_configs['A100_80GB'].get('ICN', '') , 'nodes':1, 'eff':0.8, 'real_values':True},
            {'name':'H100', 'Flops': system_configs['H100'].get('Flops', ''),
            'Memory_BW': system_configs['H100'].get('Memory_BW', ''),
            'Memory_size': system_configs['H100'].get('Memory_size', ''),
            'ICN': system_configs['H100'].get('ICN', '') , 'nodes':1, 'eff':0.8, 'real_values':True},
